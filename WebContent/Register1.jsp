			...
			<div class="header">
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li class="hvr-sweep-to-bottom active"><a href="Register.jsp">注册<i><img src="img/test/nav-but3.png" alt=""/></i></a></li>
						</ul>
			    </div>
			    
<header>
<br>
<form style="text-align:center" method="post" action="RegisterServlet">
<h1 style="position:absolute;left:1100px;top:230px;color:red;font-size:20px;">用户名已被注册<br><br>请重新想一个用户名！</h1>
...
<input class="button" type="submit" value="注册" style="text-align:center"  onclick="check()">
</br></br></br></br></br></br>
